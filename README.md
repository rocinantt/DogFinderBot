...
- [ ] Попробовать заменить текущию модель ансамблем 
- [ ] Расширение списка регионов
- [ ] Добавление поиска котов
  - [ ] Усовершенствование системы фильтрации для раздельного сохранения постов с собаками и с кошками.
  - [ ] Создание отдельных таблиц для котов и собак.
  - [ ] Добавить в бота возможность выбирать вид искомого животного.
