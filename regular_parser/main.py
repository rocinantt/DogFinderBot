...
from database import save_posts_to_db, update_last_post_date, delete_old_posts, check_group_exists, add_group_to_db, \
    conn_pool
...
def check_new_posts_for_group(group):
    ...
    group_id, last_post_date, region, area, include_reposts = group
    ...
    if group_name and group_link:
        ...
        if new_posts:
            save_posts_to_db(new_posts, region, area)
