...
async def clear_state(dispatcher: Dispatcher, chat_id: int, user_id: int, timeout: int = 60):
    ...
    await state.clear()
    await dispatcher.bot.send_message(chat_id, "Сессия истекла, данные были очищены.")
